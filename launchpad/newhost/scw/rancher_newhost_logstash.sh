...
read -p 'Enter the new host ip adress managed by rancher, logstash : ' ip_minion
...
ansible-playbook /etc/ansible/playbooks/newhost/scw/rancher_newhost_logstash.yaml
exit